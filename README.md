> [!WARNING]
> This repository has been deprecated and will no longer be updated. For the latest library template, see [processing/processing-library-template](https://github.com/processing/processing-library-template)
