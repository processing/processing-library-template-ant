...
{
	private static jp.nyatla.mimic.mbedjs.javaapi.PortOut _new(Mcu i_mcu,int i_port,int i_mask){
		try{
			return new jp.nyatla.mimic.mbedjs.javaapi.PortOut(i_mcu._inst,i_port,i_mask);
